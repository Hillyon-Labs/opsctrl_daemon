 ...
 */
export type FailurePattern = 'pod-phase-failed' | 'long-pending' | 'high-restart-count' | 'container-waiting-error' | 'container-terminated-error' | 'resource-constraint' | 'image-pull-failure' | 'configuration-error' | 'network-isolation' | 'storage-failure';
/**
...
//# sourceMappingURL=watchdog.interfaces.d.ts.map